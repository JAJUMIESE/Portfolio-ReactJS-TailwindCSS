		...
		<div className='grid grid-col-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[70vh] mx-auto py-8 bg-black'>
			...
			<div className='col-span-2 px-5 my-auto'>
				...
				<p className='text-white sm:text-lg my-6 lg:text-xl'>
					Меня зовут Денис Ноговицын, я руководитель проекта SITIM с опытом управления более года. Наша команда успешно движется к деплою продукта, запланированному на конец второго квартала 2025 года. Обладаю навыками frontend-разработки и проектирования UI/UX, а также пониманием юридических и налоговых аспектов, что позволяет мне эффективно сочетать техническую часть с управлением бизнес-процессами. Готов обсудить, как мой опыт и инициативность могут усилить вашу команду и внести ценный вклад в ваши проекты. ООО "СИТИМ БИЗНЕС" ИНН 1400040521
				</p>
